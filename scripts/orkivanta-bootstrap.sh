#!/usr/bin/env bash
# scripts/orkivanta-bootstrap.sh
#
# One-time prep for the sandbox VPS BEFORE the new runner-build deploy
# workflow (`.github/workflows/deploy-orkivanta-sandbox.yml`) ships its first
# release.
#
# Run this on the VPS as the deploy user, once:
#
#   ssh orkivanta 'cd /home/orkivanta-sandbox/htdocs/sandbox.orkivanta.com && bash scripts/orkivanta-bootstrap.sh'
#
...
APP_DIR=${APP_DIR:-/home/orkivanta-sandbox/htdocs/sandbox.orkivanta.com}
