/**
 * Seeds an ASM (Area Sales Manager) test user (BRD §0.1 persona).
 *
 *   email:    asm.itarang@gmail.com
 *   password: password
 *   role:     asm
 *
 * Writes to BOTH:
 ...
 *
 * Usage: node scripts/seed-asm-user.js
 * Requires (.env.local):
...
async function run() {
    console.log(`Seeding asm user: ${USER.email}`);
