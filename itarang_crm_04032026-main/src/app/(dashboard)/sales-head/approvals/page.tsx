...
import { approvals, deals } from '@/lib/db/schema';
...
export default async function SalesHeadApprovalsPage() {
    ...
    const pendingApprovals = await db.select()
        ...
        .where(and(
            ...
            eq(approvals.approver_role, 'sales_head'),
        ...
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                    ...
                    <p className="text-3xl font-black text-gray-900">4 Hours</p>
                </div>
            </div>
            ...
            <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <div className="flex items-center gap-2">
                                        <span className="text-[10px] font-black uppercase tracking-tighter bg-gray-900 text-white px-2 py-0.5 rounded">LEVEL 1</span>
                ...
                {pendingApprovals.length === 0 && (
                    <div className="bg-green-50/50 border-2 border-dashed border-green-100 rounded-3xl p-16 text-center">
                        ...
                        <p className="text-sm text-green-600 font-medium">No pending Level 1 approvals.</p>
                    </div>
                )}
            </div>
        </div>
