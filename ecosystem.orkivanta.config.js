// ecosystem.orkivanta.config.js
// pm2 config for the Hostinger VPS sandbox deployment.
// Managed by .github/workflows/deploy-orkivanta-sandbox.yml — do not edit on the server.
module.exports = {
  apps: [
    {
      name: "orkivanta-web",
      ...
      //
      // `current/` is a symlink maintained by .github/workflows/deploy-orkivanta-sandbox.yml
