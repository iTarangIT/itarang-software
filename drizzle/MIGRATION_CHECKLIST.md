...
<!-- NUMBER COLLISION: E-185..E-188 exist twice — the risk-engine family
     ...
     Next free number is E-218 (E-214 is TWICE-taken — whatsapp_onboarding_operators on main; drive_expense_ingestion was authored as E-214 and renumbered to E-216 to avoid a fifth duplicate slot, with expense_currency_conversion following as E-217 to keep the apply order; E-199 is TWICE-taken — nbfc_risk_card_visibility on main and, historically, a notifications one renumbered to E-200; E-200 is notifications_archive_delete). Match on the FULL filename, not the number alone.
