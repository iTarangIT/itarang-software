...
CREATE TABLE "dealer_onboarding_applications" (
	...
	"onboarding_status" varchar(30) DEFAULT 'draft' NOT NULL,
	...
	"dealer_account_status" varchar(30) DEFAULT 'inactive',
	"dealer_code" text
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "leads" DROP CONSTRAINT "leads_uploader_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "leads" DROP CONSTRAINT "leads_qualified_by_users_id_fk";
--> statement-breakpoint
...
ALTER TABLE "leads" ADD COLUMN "dealer_name" text;--> statement-breakpoint
...
ALTER TABLE "leads" ADD COLUMN "follow_up_history" jsonb;--> statement-breakpoint
ALTER TABLE "leads" ADD COLUMN "current_status" text;--> statement-breakpoint
ALTER TABLE "leads" ADD COLUMN "total_attempts" integer;--> statement-breakpoint
ALTER TABLE "leads" ADD COLUMN "final_intent_score" integer;--> statement-breakpoint
...
ALTER TABLE "leads" DROP COLUMN "lead_source";--> statement-breakpoint
ALTER TABLE "leads" DROP COLUMN "owner_name";--> statement-breakpoint
ALTER TABLE "leads" DROP COLUMN "owner_contact";--> statement-breakpoint
ALTER TABLE "leads" DROP COLUMN "state";--> statement-breakpoint
ALTER TABLE "leads" DROP COLUMN "city";--> statement-breakpoint
ALTER TABLE "leads" DROP COLUMN "interest_level";--> statement-breakpoint
ALTER TABLE "leads" DROP COLUMN "interested_in";--> statement-breakpoint
ALTER TABLE "leads" DROP COLUMN "lead_status";--> statement-breakpoint
ALTER TABLE "leads" DROP COLUMN "uploader_id";--> statement-breakpoint
ALTER TABLE "leads" DROP COLUMN "qualified_by";--> statement-breakpoint
ALTER TABLE "leads" DROP COLUMN "qualified_at";--> statement-breakpoint
ALTER TABLE "leads" DROP COLUMN "qualification_notes";--> statement-breakpoint
ALTER TABLE "leads" DROP COLUMN "updated_at";--> statement-breakpoint
