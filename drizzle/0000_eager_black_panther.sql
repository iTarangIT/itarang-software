...
CREATE TABLE "deals" (
	...
	"transportation_cost" numeric(10, 2) DEFAULT '0' NOT NULL,
	...
	"deal_status" varchar(50) DEFAULT 'pending_approval_l1' NOT NULL,
...
CREATE TABLE "lead_assignments" (
	...
	"lead_actor" uuid,
	"actor_assigned_by" uuid,
	"actor_assigned_at" timestamp with time zone,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "leads" (
	...
	"interest_level" varchar(20) DEFAULT 'cold' NOT NULL,
	...
	"mobile" varchar(20),
	"permanent_address" text,
	"vehicle_ownership" varchar(50),
	"battery_type" varchar(50),
	"asset_model" text,
	"asset_price" numeric(12, 2),
	...
	"phone" varchar(20),
	"current_address" text,
	"is_current_same" boolean DEFAULT false NOT NULL,
	...
	"interested_in" jsonb,
	"battery_order_expected" integer,
	...
	"last_ai_call_at" timestamp with time zone,
	"last_call_outcome" text,
	"ai_priority_score" numeric(5, 2),
	"next_call_after" timestamp with time zone,
	"do_not_call" boolean DEFAULT false,
	"ai_managed" boolean DEFAULT false,
	"ai_owner" text,
	"manual_takeover" boolean DEFAULT false,
	"last_ai_action_at" timestamp with time zone,
	...
	"has_additional_docs_required" boolean DEFAULT false,
	"interim_step_status" varchar(20),
	"kyc_draft_data" jsonb,
	"sm_review_status" varchar(30) DEFAULT 'not_submitted',
	"submitted_to_sm_at" timestamp with time zone,
	"sm_assigned_to" uuid,
	"uploader_id" uuid NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "leads_reference_id_unique" UNIQUE("reference_id")
);
--> statement-breakpoint
...
CREATE TABLE "oems" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "oems_gstin_unique" UNIQUE("gstin")
);
--> statement-breakpoint
...
CREATE TABLE "orders" (
	...
	"order_status" varchar(50) DEFAULT 'pi_awaited' NOT NULL,
...
ALTER TABLE "inventory" ADD CONSTRAINT "inventory_oem_id_oems_id_fk" FOREIGN KEY ("oem_id") REFERENCES "public"."oems"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "leads" ADD CONSTRAINT "leads_uploader_id_users_id_fk" FOREIGN KEY ("uploader_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "oems" ADD CONSTRAINT "oems_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "orders" ADD CONSTRAINT "orders_provision_id_provisions_id_fk" FOREIGN KEY ("provision_id") REFERENCES "public"."provisions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "orders" ADD CONSTRAINT "orders_oem_id_oems_id_fk" FOREIGN KEY ("oem_id") REFERENCES "public"."oems"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "provisions" ADD CONSTRAINT "provisions_oem_id_oems_id_fk" FOREIGN KEY ("oem_id") REFERENCES "public"."oems"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "provisions" ADD CONSTRAINT "provisions_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "slas" ADD CONSTRAINT "slas_escalated_to_users_id_fk" FOREIGN KEY ("escalated_to") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "service_tickets_asset_id_idx" ON "service_tickets" USING btree ("deployed_asset_id");