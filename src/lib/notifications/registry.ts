...
export const TYPE_LABELS: Record<string, string> = {
  ...
  // --- Ecofy workspace (E-307) ---
  "ecofy.lead_received": "Ecofy: new lead pushed from Ecofy",
  "ecofy.lead_assigned": "Ecofy: lead assigned to you",
  "ecofy.lead_unassigned": "Ecofy: lead moved to someone else",
  "ecofy.stage_changed": "Ecofy: lead moved to a new stage",
  "ecofy.lead_returned": "Ecofy: lead returned to Ecofy",
  "ecofy.lead_closed": "Ecofy: lead closed",
  "ecofy.lead_reopened": "Ecofy: lead reopened",
  "ecofy.activity_logged": "Ecofy: call / remark logged",
  "ecofy.follow_up_due": "Ecofy: follow-up due",
  "ecofy.appointment_updated": "Ecofy: meeting booked or updated",
  "ecofy.appointment_reminder": "Ecofy: meeting starts within the hour",
  "ecofy.assessment_updated": "Ecofy: assessment saved or confirmed",
  "ecofy.eligibility_requested": "Ecofy: eligibility check requested",
  "ecofy.eligibility_decided": "Ecofy: eligibility decided",
  "ecofy.quote_updated": "Ecofy: EPC quote requested or uploaded",
  "ecofy.offer_sent": "Ecofy: offer composed / OTP sent",
  "ecofy.file_locked": "Ecofy: customer accepted — File locked",
  "ecofy.financing_updated": "Ecofy: financing decision or payment",
  "ecofy.installation_updated": "Ecofy: installation updated",
  "ecofy.withdrawal_requested": "Ecofy: withdrawal requested",
  "ecofy.withdrawal_decided": "Ecofy: withdrawal confirmed / rejected",
  "ecofy.document_updated": "Ecofy: document uploaded or deleted",
  "ecofy.sync_failed": "Ecofy: sync with Ecofy failed",
