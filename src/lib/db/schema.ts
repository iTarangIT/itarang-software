...
//     // agreementLanguage: text("agreement_language").default("english"),
...
/**
 * Dealer Documents Table (S3 files metadata)
 */
export const dealerDocuments = pgTable("dealer_documents", {
    id: uuid("id").defaultRandom().primaryKey(),
...
export const dealerOnboardingDocuments = pgTable(
    "dealer_onboarding_documents",
    {
        ...
        docStatus: varchar("doc_status", { length: 50 }).default("uploaded"),
