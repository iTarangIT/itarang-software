...
export const leads = pgTable("leads", {
  ...
  // E-285 — multi-party delete. Deleting an application hides it from the
...
// EMPTY map, so an unapplied E-284 resolves everything through emailWorthy() —
// i.e. exactly today's behaviour. See the E-284 file for the rest.
// -----------------------------------------------------------------------------
...
export const nbfcLeadAssignments = pgTable(
  "nbfc_lead_assignments",
  {
    ...
    // E-285 — this NBFC deleted the application from its own Acquire pipeline.
...
// =============================================================================
// E-287/E-288 — the digest send ledger
//
...
//
// Was `dealer_validation_digest_runs` under E-287; renamed by E-288 when a
// second kind arrived.
// =============================================================================
...
export const cityDefaultLoanProducts = pgTable(
  ...
  {
    id: serial("id").primaryKey(),
    // E-283 — accounts.id / leads.dealer_id, i.e. the dealer CODE varchar and
