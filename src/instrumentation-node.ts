...
// ---------------------------------------------------------------------------
// E-285/E-286 — scheduled digest emails.
//
...
export async function startDigestTicker() {
  ...
  // and drive-mirror (180s). Nothing here is urgent to the minute, and a digest
  // is the last thing that should compete with the app finishing its boot.
