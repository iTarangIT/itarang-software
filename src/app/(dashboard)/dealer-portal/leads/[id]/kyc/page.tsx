...
const DEFAULT_CUSTOMER_VERIFICATIONS: VerificationRow[] = [
                ...
                <main className="grid grid-cols-1 gap-4 sm:gap-6">
                    ...
                    <SectionCard title="Customer Consent" action={
                        ...
                        {isFinalConsentStatus(consentStatus) ? (
                            ...
                            <div className="space-y-4">
                                <p className="text-sm text-gray-500">Choose one method to obtain customer consent.</p>
                                    ...
                                    <div className="relative p-5 rounded-2xl border-2 border-gray-200 bg-white">
                                        <div className="flex items-start gap-3 mb-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-gray-500 mt-0.5">Verify the customer with a 6-digit OTP delivered by an automated call.</p>
                                            </div>
                                        </div>
                                        <ConsentOtpCard
                                            leadId={leadId}
                                                ...
                                                {(consentStatus === 'consent_generated' || consentStatus === 'consent_uploaded' || consentPdfUrl) && (
                                                    <>
                                                        ...
                                                        <div className="p-2.5 bg-green-50 border border-green-200 rounded-lg">
                                                            <p className="text-xs text-green-700 font-medium"><CheckCircle2 className="w-3 h-3 inline mr-1" />Print the PDF, get the customer's signature, scan it, then upload below.</p>
                                                        </div>
