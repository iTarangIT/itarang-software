...
export default function KYCErrorBoundary({
    error,
    reset,
}: {
    ...
    useEffect(() => {
        console.error('[KYC Page] Render error:', error);
    }, [error]);
            ...
            <div className="max-w-md w-full bg-white border border-gray-100 rounded-2xl shadow-sm p-8 text-center space-y-5">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                        The KYC page couldn&apos;t load. Please try again, or return to lead creation.
                    </p>
                    {error?.digest && (
