...
// The wording lives with the filter vocabulary, not here: the chip on a row and
// the option that selects it must read identically, and two copies of nine
// labels is two copies to keep in step.
...
const STATUS_COLORS: Record<LeadStatus, { bg: string; text: string; border: string }> = {
    New_Unassigned: { bg: "bg-slate-50", text: "text-slate-700", border: "border-slate-200" },
    Assigned_Not_Contacted: { bg: "bg-blue-50", text: "text-blue-700", border: "border-blue-200" },
    Under_Discussion: { bg: "bg-sky-50", text: "text-sky-700", border: "border-sky-200" },
    Commercials_Explained: { bg: "bg-indigo-50", text: "text-indigo-700", border: "border-indigo-200" },
