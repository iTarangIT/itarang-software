/**
 * POST /api/nbfc/acquire/[leadId]/kyc/aadhaar/digilocker/resend-sms
 *
 * NBFC mirror of the admin primary-Aadhaar DigiLocker resend-sms route
 * (src/app/api/admin/kyc/[leadId]/aadhaar/digilocker/resend-sms/route.ts).
 * Resends the DigiLocker SMS to the CUSTOMER for the most recent non-terminal
 * transaction without burning a second Decentro credit. NBFC auth
...
export async function POST(
  ...
  try {
    ...
    console.error("[NBFC DigiLocker Resend-SMS] Error:", error);
    const message =
