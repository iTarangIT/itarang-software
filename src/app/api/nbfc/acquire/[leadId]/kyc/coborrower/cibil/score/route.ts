/**
 * POST /api/nbfc/acquire/[leadId]/kyc/coborrower/cibil/score
 *
 * NBFC mirror of the admin co-borrower CIBIL score route. Re-runs the
 * co-borrower's credit-bureau score via the shared @/lib/kyc/cibil-verification
 * helper and refreshes the shared kyc_verifications row
 * (applicant='co_borrower'). Unlike the admin route it does NOT stamp the
 * coupon / first-API-execution metadata (co-borrower admin route doesn't
 * either, but this is explicit).
 *
