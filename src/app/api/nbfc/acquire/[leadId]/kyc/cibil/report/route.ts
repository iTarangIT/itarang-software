/**
 * POST /api/nbfc/acquire/[leadId]/kyc/cibil/report
 *
 * NBFC mirror of the admin primary CIBIL report route. Re-runs the applicant's
 * full credit-bureau report via the shared @/lib/kyc/cibil-verification helper
 * and refreshes the shared kyc_verifications row (applicant='primary'). Unlike
 * the admin route it does NOT stamp the coupon / first-API-execution metadata.
 *
