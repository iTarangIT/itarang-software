...
// Shared by the Inside Sales queue and the ASM queue (B3): both dashboards
// claim through the same /api/inside-sales/lead/[id]/claim route, whose role
// gate is CLAIM_ROLES in @/lib/inside-sales/types.
