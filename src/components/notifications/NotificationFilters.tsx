...
/**
 * Filter + search controls for the CRM-wide notification pages. Status (All /
 * Unread / Read), an Inbox/Archived view toggle, category pills, and a client
 * search box. Purely presentational — the page owns the state and re-queries.
 *
 * Same shape as the buyback module's filters; the category list comes from the
 * CRM-wide catalog instead, so it covers every domain (Leads, KYC & Consent,
 * NBFC Requests, Field Investigation, …) and not just the buyback eight.
 */

import { Search } from "lucide-react";

import { CATEGORIES, type NotificationCategory } from "@/lib/notifications/catalog";
...
export interface NotificationFiltersProps {
  ...
  /** Categories to offer. Defaults to the full CRM list. */
