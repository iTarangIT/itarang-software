    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-4">
                {/* The shared CRM-wide bell — the same component every other
                    portal runs. This header used to carry its own bell showing
                    ONLY live work-queue counts: no events, no read state, no
                    history, so an NBFC user was never told when a document was
                    pushed to them, a verdict answered, or an agreement signed.
                    The counts were worth keeping, so they render above the feed
                    as `headerSlot` rather than being replaced by it. */}
                <NotificationBell portalRole="nbfc" headerSlot={<NbfcWorkQueueBlock />} />
